...
PDFS := target/cours.pdf target/calculdiff.pdf target/polynomes.pdf target/algebre-generale.pdf target/arithmetique.pdf target/reduction.pdf target/analyse-asymptotique.pdf target/integration.pdf
