...
\begin{proof}~
    ...
    \item $(a) \implies (b)$: \[
        ...
        \end{align*}
        donc $f$ est différentiable sur $\Omega$. Si $F\neq \mathbb R$ on raisonne coordonnée par coordonnée.
\end{enumerate}
\end{proof}
