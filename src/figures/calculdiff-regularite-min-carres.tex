...
\begin{document}
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot3[domain=-0.58:0.13, samples=10, smooth, samples y =0, line width=1pt] ({x}, 0, 0);
                \addplot3[domain=1.01:1.2, samples=10, smooth, samples y =0, line width=1pt] ({x}, 0, 0);
                \addplot3[domain=-1.2:0.6, samples=10, smooth, samples y =0, line width=1pt] (0, {x}, 0);
                ...
                \addplot3[domain=0.32:1.2, samples=10, smooth, samples y =0, line width=1pt] (-1.2, {x}, {x^2});
                \addplot3[domain=-1.2:-0.13, samples=10, smooth, samples y =0, line width=1pt] ({x}, 1.2, {x^2});
            \end{axis}
        \end{tikzpicture}
\end{document}
