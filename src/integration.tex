...
\begin{prop}
    ...
    \item $f$ est intégrable sur $I$ si et seulement s'il existe $M\geq 0$ tel que \[
        ...
        \]
    \item Si $0\leq f\leq g$ et $g$ intégrable sur $I$ alors $g$ est aussi intégrable
    \item Si $I=[a, b[$, $f=O_b(g)$ et $g$ intégrable au voisinage de $b$ alors $f$ est aussi intégrable au voisinage de $f$.
    \end{concenum}
\end{prop}
