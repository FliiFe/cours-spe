...
\subsection{$\mathbb Z_{p^\alpha}^\star$ est cyclique}
...
\end{itemize}
Il est suffisant de trouver un élément de $(\mathbb Z/p^\alpha\mathbb Z)^\star$ d'ordre $\varphi(p^\alpha)=(p-1)p^{\alpha-1}$, et vu la stabilité des ordres par ppcm vue précédemment, il est suffisant de trouver un élément d'ordre $p-1$ et un élément d'ordre $p^{\alpha-1}$.
...
Il reste à trouver un élément d'ordre $p-1$. On sait que $\mathbb F_p^\star$ est cyclique, on note $g$ un générateur. On a:
\[
