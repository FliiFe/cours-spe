...
\begin{res}[Enestrom-Kakeya]
    ...
    Si $P(x)=a_{n-1}x^{n-1}+\cdots +a_0$ est un polynôme à coefficients strictement positifs, alors si $z$ est une racine complexe de $P$, \[
...
\item $\cdots$
\end{itemize}
On construit ainsi deux suites $(x_n)_n\in E^{\N}$, $(r_n)\in {\R_+^\star}^{\N}$ telles que \[
    \begin{cases}
