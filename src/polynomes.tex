...
\end{res}
\begin{proof}
Si le polynôme est irréductible dans $\mathbb Q[X]$ alors il l'est dans $\mathbb Z[X]$. On suppose $P$ irréductible dans $\mathbb Z[X]$ et $P=AB$ dans $\mathbb Q[X]$. Il existe $p, q$ minimaux positifs tels que $pqP=pAqB$, $pA$ et $pQ$ dans $\mathbb Z[X]$ et \[
